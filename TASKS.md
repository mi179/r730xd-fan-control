...
| T-019 | 防止桌面「源码已改、dist 里还是旧 EXE、版本号却相同」再次发生：至少让 `build_windows.ps1` 或治理自检能指出当前 `dist/` 产物对应的源码提交，落后就明说。Web 线因为每次部署都重新构建而没暴露此问题，桌面线没有等价约束 | Open（2026-08-19 由 E-036 引出；本次已按 D-024 手工重建，但机制仍缺） | D-013, D-024, E-036 |
